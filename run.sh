...
CUDA_LAUNCH_BLOCKING=1 NCCL_DEBUG=INFO srun python ./trainer/train_webds.py --config briar_11
# CUDA_LAUNCH_BLOCKING=1 NCCL_DEBUG=INFO srun python ./trainer/extract_chips.py --config briar_8
